            ...
            with st.spinner("Generating Quote..."):
                if not st.session_state["generating_quote"]:
                    ...
                    if email_text:
                        ...
                        og_file_type, pdf_file = generate_quote(quote_template[0], email_text, product_catalog_text, st.session_state.context_from_user, st.session_state["user"])
                        og_file_type = docx_to_bytes(og_file_type)
                        ...
                        st.download_button(
                            ...
                            data=og_file_type.getvalue() if isinstance(og_file_type, io.BytesIO) else open(og_file_type, "rb"),
